...
- **CatClipComposer.Plugins.BuiltIn assembly 0.1.24:** First-party dynamic module assembly containing
...
`Directory.Build.props` supplies version 0.1.24 to the WPF, CLI, Core, Infrastructure, and built-in plugin
projects, including
