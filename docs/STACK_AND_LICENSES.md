...
- **CatClipComposer.Plugins.BuiltIn 1.0.0:** First-party dynamic module assembly containing background blur,
  video blur, and PNG source support. It adds no NuGet or third-party runtime dependency and ships under
  `plugins`.
...
`Directory.Build.props` supplies version 0.1.6 to the WPF, CLI, Core, Infrastructure, and built-in plugin
projects, including
