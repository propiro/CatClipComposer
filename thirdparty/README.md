...
The repository intentionally contains no third-party executable. Pass an audited FFmpeg directory to `scripts\Publish-Portable.ps1` when preparing a complete distribution.
